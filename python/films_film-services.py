...
http://api-docs.letterboxd.com/#path--films-film-services

Python 3:
$ python3 ./films_film-services.py

Python 2.7:
For use with Python 2.7 replace `input(...)` with `raw_input(...)`
$ python ./films_film-services.py
...
def films_film_services():
    ...
    method = 'get'
    url = base_url + '/films/film-services'
