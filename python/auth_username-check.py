...
http://api-docs.letterboxd.com/#path--auth-username-check

Python 3:
$ python3 ./auth_username-check.py

Python 2.7:
For use with Python 2.7 replace `input(...)` with `raw_input(...)`
$ python ./auth_username-check.py
...
def auth_username_check():
    ...
    method = 'get'
    url = base_url + '/auth/username-check'
    ...
    # set endpoint specific GET parameters
