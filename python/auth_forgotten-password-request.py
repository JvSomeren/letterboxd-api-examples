...
http://api-docs.letterboxd.com/#path--auth-forgotten-password-request

Python 3:
$ python3 ./auth_forgotten-password-request.py

Python 2.7:
For use with Python 2.7 replace `input(...)` with `raw_input(...)`
$ python ./auth_forgotten-password-request.py
...
def auth_forgotten_password_request():
    ...
    method = 'post'
    url = base_url + '/auth/forgotten-password-request'
    ...
    # define request body as specified here http://api-docs.letterboxd.com/#/definitions/ForgottenPasswordRequest
    body = json.dumps(
        {
    ...
    if response.status_code == 204:
        ...
        print('Too many forgotten password requests have been received for this email address.',
              'The email is probably in the member\'s spam folder')


if __name__ == "__main__":
    auth_forgotten_password_request()
