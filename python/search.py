"""
GET /search
http://api-docs.letterboxd.com/#path--search
...
def search():
    ...
    # other available GET parameters are:
    # (see here for the allowed values http://api-docs.letterboxd.com/#/definitions/SearchRequest)
    # params['cursor'] = cursor
    # params['perPage'] = 20
    # params['searchMethod'] = 'FullText'
    # params['include'] = ['ContributorSearchItem', 'FilmSearchItem']
